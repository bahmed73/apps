...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title><f:display bean="documentation" property="name"/></title>
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><div data-href="${createLink(action: 'show', controller: 'documentation', id: documentation.id)}" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftaote.shop%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div></button></li>
									...
									<div>
										<div class="row">
											<div id="block1" class="12u">
													...
													<header>
														<span style="font-size:35px;color:#000000"><f:display bean="documentation" property="name"/></span>
													</header>
													<br><br>
													<p style="font-size:20px;color:#000000;">Description: <f:display bean="documentation" property="description"/></p>
													<br>
													<p style="font-size:20px;color:#000000;;">Create Time: <g:formatDate format="MM-dd-yyyy" date="${documentation.createTime}"/></p>
													<br>
													<p style="font-size:20px;color:#000000;">Update Time: <g:formatDate format="MM-dd-yyyy" date="${documentation.updateTime}"/></p>
													<br>

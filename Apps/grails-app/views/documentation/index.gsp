...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title>Product Docs - Business documentation.</title>
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><g:link controller="documentation" action="create">Create a Document</g:link></button></li>
												<li><button class="button"><div class="fb-share-button" data-href="${createLink(action: 'index', controller: 'documentation')}" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftaote.shop%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div></button></li>
										...
										<div>
											<div class="row">
												<div id="block1" class="12u">
														...
														<br><br>
														<p style="font-size:20px;color:#fdeba9;">Description: ${documentationInstance.description}</p>
														<br>
														<p style="font-size:20px;color:#fdeba9;">Create Date: <g:formatDate format="yyyy-MM-dd" date="${documentationInstance.createTime}"/></p>
														<br>

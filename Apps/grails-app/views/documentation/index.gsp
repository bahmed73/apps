...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title>Documentation - Building agile development and lean startup tools, for entrepreneurs, venture capital, startups and project manager.</title>
				...
				<div class="container">
					...
					<div class="row">
						<div id="block3" class="12u">
							...
							<div class="fb-share-button" data-href="http://taote.shop/documentation" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftaote.shop%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
							</div>						

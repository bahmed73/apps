...
<html>
    ...
    <body>
        ...
        <div id="show-backlog" class="content scaffold-show" role="main">
            ...
            <f:display bean="backlog" />
            <g:form resource="${this.backlog}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.backlog}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

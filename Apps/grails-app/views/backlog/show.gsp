...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title><f:display bean="backlog" property="name"/></title>
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><g:link controller="backlog" action="edit" id="${backlog.id}">Edit Backlog</g:link></button></li>
												<li><button class="button"><g:link controller="backlog" action="index">Show Backlogs</g:link></button></li>
												<li><button class="button"><div data-href="${createLink(action: 'show', controller: 'backlog', id: backlog.id)}" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftaote.shop%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div></button></li>
...
<section>
							...
							<div class="4u">
								...
								<section>
									...
									<ul class="divided">
										<li><a href="https://facebook.com/mytweetmark/"><h3>On Facebook</h3></a></li>
							...
							<section>
									...
									<ul class="divided">
										...
										<li><a href="https://twitter.com/mytweetmark"><h3>On Twitter</h3></a></li>

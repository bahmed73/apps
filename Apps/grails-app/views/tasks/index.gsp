...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title>Task - Building agile development and lean startup tools, for entrepreneurs, venture capital, startups and project manager.</title>
				...
				<div class="container">
					...
					<div class="row">
						<div id="block3" class="12u">
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><g:link controller="tasks" action="create">Create a Task</g:link></button></li>
							...
							<div class="fb-share-button" data-href="http://taote.shop/tasks" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftaote.shop%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
							</div>						
						
							<g:if test="${tasksList}">
							<g:each in="${tasksList}" status="i" var="tasksInstance">
								<div class="row">
								<div class="12u">
									<section>
										<div>

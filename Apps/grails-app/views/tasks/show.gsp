							...
							<!-- Banner -->
								<section id="banner">
									<a href="https://mauget.com/">
										<span class="image image-full"><asset:image src="taim_banner_7.png"/></span>
										<header>
											<!--  <h2>Foodal</h2>-->
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><g:link controller="tasks" action="edit" id="${tasks.id}">Edit Tasks</g:link></li>
												<li><g:link controller="tasks" action="index">Show Tasks</g:link></li>
									...
									<div>
										<div class="row">
											<div id="block1" class="6u">
													...
													<br><br>
													<p style="font-size:18px;color:#8a7e7e;">Projects: <f:display bean="tasks" property="project.name"/></p>
													<br><br>
												</section>
											</div>
											<div id="block2">

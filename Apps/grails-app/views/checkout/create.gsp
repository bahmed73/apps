...
var stripe = Stripe('pk_test_u3s8kQvrcV1PO01gYVOmJmCO00vnKwU0cT');
						...
						<div class="12u">
							...
							<g:form action="save" method="POST">
								...
								<div class="form-row">
								    <label>
								      <span>Amount</span>
								      <input type="text" name="amount" readonly="readonly" size="20" value="${checkout.amount}"/>
								    </label>
								  </div>
				                <br>
								...
								<label class="containerment">Domestic Shipment.
								  <input type="checkbox" name="domesticShipment" checked="checked">
								  <span class="checkmark"></span>
								</label>
								<label class="containerment">International Shipment.
								  <input type="checkbox" name="internationalShipment">
								  <span class="checkmark"></span>
								</label>
								<label class="containerment">Use Paypal.
								  <input type="checkbox" name="usePaypal">
								  <span class="checkmark"></span>
								</label>
								<br><br>

...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title><f:display bean="notes" property="name"/></title>
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><div data-href="${createLink(action: 'show', controller: 'notes', id: notes.id)}" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftaote.shop%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div></button></li>
										...
										<div class="row">
											...
											<div id="block2">
												...
												<g:if test="${notes.imageThree}">
													...
													<img src="data:image/png;base64,${notes.imageThree?.encodeBase64()}" width="250px"/>
													<br><br>

...
<html>
	<head>
		<meta name="description" content="Community Book Exchange" />
...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title>Community Book Exchange - Pickup</title>
...
<script>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><g:link controller="donateBook" action="index"><span style="color:#feff00">Donated Books</span></g:link></button></li>
												<li><button class="button"><g:link controller="pickupBook" action="create"><span style="color:#feff00">Pickup a Book!</span></g:link></button></li>
							...
							<div class="12u">
							<g:if test="${pickupBookList}">
							<g:each in="${pickupBookList}" status="i" var="pickupBookInstance">
									<section>
								...
								<div class="12u">
									...
									<div>
										...
										<div class="6u">
													...
													<header>
													<g:link controller="pickupBook" action="create"><span style="font-size:28px;color:#000000;">Please pickup a book.</span></g:link>
													</header>
													</section>
										</div>
									</div>

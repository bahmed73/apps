...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title><f:display bean="donateBook" property="name"/></title>
						...
						<div class="12u">
							...
							<!-- Banner -->
								<section id="banner">
										...
										<g:link class="list" action="index" controller="blogCategory"><span class="image image-full"><asset:image src="satoshi-2.png"/></span></g:link>
										<header>
											<!--  <h2>Foodal</h2>-->
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><g:link controller="donateBook" action="edit" id="${donateBook.id}"><span style="color:#feff00">Edit Donate Book</span></g:link></button></li>
												<li><button class="button"><g:link controller="donateBook" action="index"><span style="color:#feff00">Show Donated Books</span></g:link></button></li>
												<li><button class="button"><div class="fb-share-button" data-href="${createLink(action: 'show', controller: 'donateBook', id: donateBook.id)}" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fbookly.love%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore"><span style="color:#feff00">Share</span></a></div></button></li>
												...
												<li><button class="button"><g:form resource="${this.donateBook}" method="DELETE" controller="donateBook" action="delete">
									...
									<div>
										<div class="row">
											<div class="6u">
													...
													<header>
														<span style="font-size:35px;color:#000000">Book name: ${donateBook.name}</span>
													</header>
													<br><br>
													<span style="font-size:20px;color:#000000;font-family: Arial, Helvetica, sans-serif;">Description: ${donateBook.description}</span>
													<br><br>
													<span style="font-size:20px;color:#000000;font-family: Arial, Helvetica, sans-serif;">Subtitle: ${donateBook.subtitle}</span>
													<br><br>
											...
											<div>
												<section class="box">
												<header>
												<g:if test="${donateBook.imageThree}">
													<div style="border: 2px solid #e5e1e1;width:250px;">
													<p><img src="data:image/png;base64,${donateBook.imageThree?.encodeBase64()}" width="200px"/></p>
													<br>
													<br>

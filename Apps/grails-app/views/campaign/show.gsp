...
<html>
    ...
    <body>
        ...
        <div id="show-campaign" class="content scaffold-show" role="main">
            ...
            <f:display bean="campaign" />
            <g:form resource="${this.campaign}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.campaign}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

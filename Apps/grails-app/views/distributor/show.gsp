...
<html>
    ...
    <body>
        ...
        <div id="show-distributor" class="content scaffold-show" role="main">
            ...
            <f:display bean="distributor" />
            <g:form resource="${this.distributor}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.distributor}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

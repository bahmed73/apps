...
<html>
    ...
    <body>
        <a href="#create-photos" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-photos" class="content scaffold-create" role="main">
            ...
            <g:form action="save" method="post" enctype="multipart/form-data">
                <fieldset class="form">
                    <f:all bean="photos" except="imageOne, imageTwo, imageThree, category"/>
                </fieldset>
                <fieldset>

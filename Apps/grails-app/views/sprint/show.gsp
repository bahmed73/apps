...
<html>
    ...
    <body>
        ...
        <div id="show-sprint" class="content scaffold-show" role="main">
            ...
            <f:display bean="sprint" />
            <g:form resource="${this.sprint}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sprint}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

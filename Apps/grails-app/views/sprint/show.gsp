						...
						<div id="block3" class="12u">
							...
							<!-- Banner -->
								<section id="banner">
										...
										<span class="image image-full"><asset:image src="project-management-5.png"/></span>
										<header>
											<!--  <h2>Foodal</h2>-->
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><g:link controller="sprint" action="edit" id="${sprint.id}">Edit Sprint</g:link></li>
												<li><g:link controller="sprint" action="index">Show Sprints</g:link></li>
									...
									<div>
										<div class="row">
											<div id="block1" class="12u">
													...
													<header>
														<span style="font-size:35px;color:#9b9ea9"><f:display bean="sprint" property="name"/></span>
													</header>
													<br><br>
													<p style="font-size:20px;color:#8a7e7e;">Description: <f:display bean="sprint" property="description"/></p>
													<br>
													<p style="font-size:20px;color:#782727;">Create Time: <g:formatDate format="MM-dd-yyyy" date="${sprint.createTime}"/></p>
													<br>
													<p style="font-size:20px;color:#782727;">Update Time: <g:formatDate format="MM-dd-yyyy" date="${sprint.updateTime}"/></p>
													<br>

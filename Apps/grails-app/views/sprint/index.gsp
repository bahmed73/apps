...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title>Sprint - Building agile development and lean startup tools, for entrepreneurs, venture capital, startups and project manager.</title>
				...
				<div class="container">
					...
					<div class="row">
						<div id="block3" class="12u">
							...
							<div class="fb-share-button" data-href="http://taote.shop/sprint" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftaote.shop%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
							</div>						
								...
								<div class="12u">
									...
									<div>
										...
										<div class="6u">
													...
													<header>
													<g:link controller="sprint" action="create"><span style="font-size:28px;color:#000000;">Please create a sprint.</span></g:link>
													</header>
													</section>
										</div>
									</div>

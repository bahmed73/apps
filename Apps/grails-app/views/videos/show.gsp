...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title><f:display bean="videos" property="name"/></title>
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><g:link controller="videos" action="edit" id="${videos.id}"><span style="color:#feff00">Edit Video</span></g:link></button></li>
												<li><button class="button"><g:link controller="videos" action="index"><span style="color:#feff00">Show Videos</span></g:link></button></li>
												<li><button class="button"><span style="color:#feff00"><g:form resource="${this.videos}" method="DELETE" controller="videos" action="delete">
									...
									<div>
										<div class="row">
											<div class="6u">
													...
													<header>
														<span style="font-size:35px;color:#1d10d2"><f:display bean="videos" property="name"/></span>
													</header>
													<br><br>
													<g:if test="${videos.category}">
													<p style="font-size:20px;color:#1d10d2;">Category: <g:link action="show" controller="category" id="${videos.category.id}"><span style="font-size:20px;color:#1d10d2">${videos.category.name}</span></g:link></p>
													<br><br>
													</g:if>
													<g:if test="${videos.products}">
													<p style="font-size:20px;color:#1d10d2;">Product: <g:link action="show" controller="products" id="${videos.products.id}"><span style="font-size:20px;color:#1d10d2">${videos.products.name}</span></g:link></p>
													<br><br>
													</g:if>

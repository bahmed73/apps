...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title>Meeting - Building agile development and lean startup tools, for entrepreneurs, venture capital, startups and project manager.</title>
				...
				<div class="container">
					...
					<div class="row">
						<div id="block3" class="12u">
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><g:link controller="meeting" action="create">Create a Meeting</g:link></button></li>
							...
							<div class="fb-share-button" data-href="http://taote.shop/meeting" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftaote.shop%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
							</div>						
						
							<g:if test="${meetingList}">
							<g:each in="${meetingList}" status="i" var="meetingInstance">
								<div class="row">
								<div class="12u">
									<section>
										<div>
								...
								<div class="12u">
									...
									<div>
										...
										<div class="6u">
													...
													<header>
													<g:link controller="meeting" action="create"><span style="font-size:28px;color:#000000;">Please create a meeting.</span></g:link>
													</header>
													</section>
										</div>
									</div>

...
<html>
    ...
    <body>
        ...
        <div id="show-meeting" class="content scaffold-show" role="main">
            ...
            <f:display bean="meeting" />
            <g:form resource="${this.meeting}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.meeting}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><g:link controller="meeting" action="edit" id="${meeting.id}">Edit Meeting</g:link></li>
												<li><g:link controller="meeting" action="index">Show Meetings</g:link></li>
									...
									<div>
										<div class="row">
											<div id="block1" class="12u">
													...
													<header>
														<span style="font-size:35px;color:#9b9ea9"><f:display bean="meeting" property="name"/></span>
													</header>
													<br><br>

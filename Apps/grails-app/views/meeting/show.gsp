...
<META HTTP-EQUIV="CACHE-CONTROL" CONTENT="PUBLIC">
	...
	<title><f:display bean="meeting" property="name"/></title>
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><div data-href="${createLink(action: 'show', controller: 'meeting', id: meeting.id)}" data-layout="button" data-size="small"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftaote.shop%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div></button></li>
									...
									<div>
										<div class="row">
											<div id="block1" class="12u">
													...
													<header>
														<span style="font-size:35px;color:#000000"><f:display bean="meeting" property="name"/></span>
													</header>
													<br><br>
													<p style="font-size:20px;color:#000000;">Description: <f:display bean="meeting" property="description"/></p>
													<br>
													<p style="font-size:20px;color:#000000;">Create Time: <g:formatDate format="MM-dd-yyyy" date="${meeting.createTime}"/></p>
													<br>
													<p style="font-size:20px;color:#000000;">Update Time: <g:formatDate format="MM-dd-yyyy" date="${meeting.updateTime}"/></p>
													<br>

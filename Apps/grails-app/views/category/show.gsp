										...
										<div class="row">
											...
											<div class="12u">
												...
												<header>
													...
													<g:link controller="products" action="show" id="${productsInstance.id}"><span style="color:#1d10d2;font-size:16px;"><img src="data:image/png;base64,${productsInstance.imageThree?.encodeBase64()}"/><br>${productsInstance.name} - ${productsInstance.price}</span></g:link>
													</div>
													</g:each>
													</g:if>
													<br><br>
											...
											<div class="12u">
												<section class="box">
													...
													<div class="3u" style="float:left;height:400px;width:300px;">
													<g:link controller="photos" action="show" id="${photosInstance.id}"><span style="color:#1d10d2;font-size:20px;"><img src="data:image/png;base64,${photosInstance.imageThree?.encodeBase64()}"/><br>${photosInstance.name}</span></g:link>
													<br><br>
													</div>	
													</g:each>
													</g:if>

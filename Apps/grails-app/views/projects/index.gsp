						...
						<div id="block3" class="12u">
							...
							<!-- Banner -->
								<section id="banner">
										...
										<span class="image image-full"><asset:image src="project-management-3.png"/></span>
										<header>
										<!-- 
											<h2>Shop</h2> 
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><g:link controller="projects" action="create">Create a Projects</g:link></li>
								...
								<div class="12u">
									...
									<div>
										...
										<div class="6u">
													...
													<header>
													<g:link controller="projects" action="create"><span style="font-size:28px;color:#8a7e7e;">Please create a projects.</span></g:link>
													</header>
													</section>
										</div>
									</div>

...
<html>
    ...
    <body>
        ...
        <div id="show-inventory" class="content scaffold-show" role="main">
            ...
            <f:display bean="inventory" />
            <g:form resource="${this.inventory}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.inventory}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

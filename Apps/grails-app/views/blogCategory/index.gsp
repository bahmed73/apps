								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><g:link controller="blog" action="index"><span style="color:#feff00">Blogs</span></g:link></button></li>
												<li><button class="button"><g:link controller="blogCategory" action="create"><span style="color:#feff00">Create a Blog Category</span></g:link></button></li>

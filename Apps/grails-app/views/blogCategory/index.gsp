									...
									<section>
											...
											<div class="6u" style="float:left;height:550px;">
												<div>
														...
														<p  style="float:left;height:500px;"><g:link controller="blogCategory" action="show" id="${blogCategoryInstance.id}"><span style="color:#ffffff;font-size:20px;"><br><img src="data:image/png;base64,${blogCategoryInstance.imageOne?.encodeBase64()}"/><br><br>${blogCategoryInstance.name}</span></g:link></p>
														</div>

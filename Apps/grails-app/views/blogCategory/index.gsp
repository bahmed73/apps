    ...
    <span class="sr-only">Next</span>
							...
							<g:each in="${blogCategoryList}" status="i" var="blogCategoryInstance">
									<section>
											...
											<div class="6u" style="float:left;height:500px;">
												<div>
														<div>
														
														<p  style="float:left;height:440px;"><g:link controller="blogCategory" action="show" id="${blogCategoryInstance.id}"><span style="color:#ffffff;font-size:20px;"><br><img src="data:image/png;base64,${blogCategoryInstance.imageOne?.encodeBase64()}"/><br><br>${blogCategoryInstance.name}</span></g:link></p>
														</div>
								...
								<div class="12u">
									...
									<div>
										...
										<div class="6u">
													...
													<header>
													<g:link controller="blogCategory" action="create"><span style="font-size:28px;color:#000000;">Please create a book category.</span></g:link>
													</header>
													</section>
										</div>
									</div>

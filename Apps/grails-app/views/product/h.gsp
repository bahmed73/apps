								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">H point</span>
														<span class="byline">H is a meditation point of making wishes come true, of finding treasures in the galaxy. It is the center of the angels, the unseen and mystics, the karbala, the jinns, the gurus.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="h.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

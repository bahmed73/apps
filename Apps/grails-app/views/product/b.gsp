								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">B point</span>
														<span class="byline">B is a meditation point of manifestation, action spoken with voice, words, tongue, language and correlation, of finding treasures in the galaxy. It is the complement of A, the female side, outward projection of A to the world, used as a trigger point.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="b.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

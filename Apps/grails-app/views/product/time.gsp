							...
							<!-- Banner -->
								<section id="banner">
									<a href="http://foodal.co">
										<span class="image image-full"><asset:image src="doctor.png"/></span>
										<header>
											<h2>Foodal</h2>
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><g:link controller="product" action="day41">Day 41</g:link></li>
												<li><g:link controller="product" action="day42">Day 42</g:link></li>
												<li><g:link controller="product" action="day43">Day 43</g:link></li>
												<li><g:link controller="product" action="day44">Day 44</g:link></li>
												<li><g:link controller="product" action="day45">Day 45</g:link></li>
												<li><g:link controller="product" action="day46">Day 46</g:link></li>
												<li><g:link controller="product" action="day47">Day 47</g:link></li>
												<li><g:link controller="product" action="day48">Day 48</g:link></li>
												<li><g:link controller="product" action="day49">Day 49</g:link></li>
												<li><g:link controller="product" action="day50">Day 50</g:link></li>
								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">Chart reading with astrology and numerology, number system of 12, aligned with planets and palmistry.</span>
														<span class="byline">12 planets: Sun, moon, mars, mercury, jupiter, venus, saturn, uranus, pluto, neptune, planet X and sumer.</span>
														<span class="byline">12 signs. Leo - Cancer.</span>
														<span class="byline">Each sign associated with either earth, water, fire and air.</span>
														<span class="byline">The astrological signs, within every soul, to predict the future, although maya is locked.</span>
														<span class="byline">Each human has the planets movement, planted in their palms, and feet.</span>
														<span class="byline">The feet contain the astrology prints, for male and female, part of the DNA code for every human (0).</span>
														<span class="byline">To study time, look at the time and break the number in single digits, e.g. 3:32pm becomes 112620170332.</span>
														<span class="byline">Measure the influence of the month, for example November - December is water and fire, then earth for January, then air for aquarius.</span>
														<span class="byline">1 - creation, 2 - compassion, 3 - creativity or shiva, 4 - form or shiva with durga, 5 - freedom or star of david, 6 - buddha or jesus.</span>
														<span class="byline">7 - God, moksha or immortal souls like heather and brahmananda, sivananda, and rest of the gurus.</span>
														<span class="byline">8 - Krishna, son, son of kali, just in case things are not going according to the plan, with shani dev, guru of shani or Saturn.</span>
														<span class="byline">9 - XYZ vidya, completion but request for re-construction by shiva, re-work of tree of life by vishnu and buddha vidya, 6-9 trinity.</span>
														<span class="byline">10 - Recreation, like shiva, throw away what is not needed, with god power behind, as shiva is the left side of god, al-mighty.</span>
														<span class="byline">11 - Indra, brought in by the wali, friend of god, the sufi, the most beloved of God, or Allah, their constant prayer, again.</span>
														<span class="byline">12 - Agni, Durga, Heather, Parvati, Tara, Kali, and all forms of the female, as december - january time is very essential for Her to dream, the female.</span>
														<span class="byline">Reset Heather (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Brahmananda (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Sivananda (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Vishnudevananda (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Satchidananda (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Saint Germain (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Nizam-ud-din Aliya (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Edhi (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Indra Gandhi (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Benazir Bhutto (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset Auro Bindu and the mother (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">Reset cheiro (0) through soul (0) and trinity mudras (0) explode, earth (0) explode.</span>
														<span class="byline">The gurus vidya for two days each, all through December 2017 till January 2018.</span>
														<span class="byline">Prayer to XYZ vidya for a happy christmas 2017 and new years 2018, indra and agni, vedanta, buddha tree and abrahims.</span>
														<span class="byline">May you understand creation like the x vidya, planet x, and the room 302 crew, that created this heavenly screen play.</span>
														<span class="byline">Thankful to ea, sumer and team, that put us in balance, sumer (0) explode, to keep me warm and also, earth (0) explode.</span>
														...
														<span class="byline">Bring it to a point, point strong, earth (0), kingdom (0), underworld (0), god (0), guru (0), student (0), soul-mate (0), loop #.</span>

								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">Y Vidya - Day 31</span>
														...
														<span class="byline">Jump from X Vidya, to Y, Z, S, T, U, V and W vidyas, 8 + 4 = 12 + 7 + 1 = 20 vidyas. Photocopy 6 for God Al-mighty.</span>
														<span class="byline">Restart system, grid with shiva, vishnu, brahma, durga, god and the mother with the power of X ^ 20.</span>
														<span class="byline">Update the germ cell, for all, plus nada cell.</span>
														<span class="byline">Restart all grids.</span>
														<span class="byline">Open all chakras and copy X cell to all, photocopy to planet x, explode room #302.</span>
														<span class="byline">Clean and close all chakras.</span>
														...
														<span class="byline">Bring it to a point, point strong, earth (0), kingdom (0), underworld (0), god (0), guru (0), student (0), soul-mate (0), school (0), loop #.</span>

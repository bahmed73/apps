								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><g:link controller="product" action="demo8">World Point</g:link></li>
								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">Point</span>
														<span class="byline">Meditate on a single cell point.</span>
														<span class="byline">Meditate on nirguna brahman, nada yoga ishwar cell point, male, invisible, indivisible.</span>
														<span class="byline">Meditate on nirguna brahmani, nada yoga ishwari point, female.</span>
														<span class="byline">Meditate on saguna brahman point, ishwar cell, male, manifestation.</span>
														<span class="byline">Meditate on saguna brahmani point, ishwar cell, female, manifestation.</span>
														<span class="byline">Meditate on nada bindu, nada being the immortal, male, soul point, bindu the female manifestation.</span>
														<span class="byline">Meditate on zen, ahata nada projection of anahata nada, OM.</span>
														<span class="byline">Meditate on para shakti, ahata nada projection of anahata nadani, female OM, or ishwari, brahmani.</span>
														<span class="byline">Meditate on shen, the dark side of zen, inverse and opposite.</span>
														<span class="byline">Meditate on tara shakti, ahata nada projection of anahata nadani, dark side of ishwari or brahmani.</span>
														<span class="byline">Bring the point, meditate next another person, exlode the point.</span>

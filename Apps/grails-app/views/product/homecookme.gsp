								...
								<section>
									<div>
										...
										<div class="6u">
													...
													<header>
														<span style="font-size:35px;">Local Food and Farmers markets!</span>
														<span class="byline">Create a business profile, market your business.</span>
													</header>
													<div>
													<ul style="list-style-type:disc; margin:50px;font-size:20px;">
													<li>Need a Twitter account.</li>
													<li>Login with Twitter into local farmers market business dashboard.</li>
													<li>Add your business to a farmers market.</li>
													<li>Add products that you sell and price.</li>
													<li>Create blogs to show case your ideas.</li>
													<li>Create food recipes to go with the products.</li>
													...
													<form controller="product" action="homecookme" method="POST">
													<script
										  			src="https://checkout.stripe.com/checkout.js" class="stripe-button"
										  			data-key="pk_live_XG5V3QMNoSvnijnOBH1SRO2I"
										  			data-amount="5000.00"
										  			data-name="homecookme"
										...
										<div class="6u">
												<section class="box">
													<a href="http://www.homecook.me" class="image image-full"><asset:image src="homecookme.png"/></a>
													<!--header>

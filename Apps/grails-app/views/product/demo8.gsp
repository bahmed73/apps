								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">World Point</span>
														<span class="byline">Meditate on the point.</span>
														<span class="byline">Heal other people with the point. Imagine the point, completely in sync with your spouse, perfectly aligned.</span>
														<span class="byline">Heal the children with the two points, male and female, ishwar and ishwari points, loop with the children, perfectly aligned.</span>
														<span class="byline">Heal the grandparents, brothers and sisters, cousins, whole family with the two points, brahman and brahmani, as in brahma vidya.</span>
														<span class="byline">Meditate on the family point.</span>
														<span class="byline">Meditate on the family point, interaction with the society, perfectly aligned, chakras balanced. Explode the point if needing validation.</span>
														<span class="byline">Meditate on the home point. See how energy of everyone resolves down to a single point.</span>
														<span class="byline">Meditate on the city point, see how energy of the whole town comes down to a single point.</span>
														<span class="byline">Meditate on the state point, see how energy of all towns within a state comes down to a single cell point.</span>
														<span class="byline">Meditate on the country point, see how energy of all the states within a country come down to a single point.</span>
														<span class="byline">Mediate on the world point, see how energy of all the countries, all the universe come down to a single point. Explode this point. Loop everyone.</span>

							...
							<!-- Banner -->
								<section id="banner">
									<a href="http://foodal.co">
										<span class="image image-full"><asset:image src="foodal-profile-6.png"/></span>
										<header>
											<h2>Foodal</h2>
								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">R point</span>
														<span class="byline">R is a meditation point of receiving, of finding treasures in the galaxy by light, energy, sun and the moon. It is the alphabet of work and energy, used as a trigger for sun signs and action.</span>
														<span class="byline">Q is a meditation point of communication, of finding treasures in the galaxy by hearing. It is the alphabet of work and assignment, used as a trigger for centering.</span>
														<span class="byline">N is a meditation point of speaking, of finding treasures in the galaxy with sound. It is the center of the alphabet, A-M, N-Z used as a trigger point forward.</span>
														<span class="byline">M is a meditation point of manifestation, of finding treasures in the galaxy. It is the center of the alphabet, A-M, N-Z used as a trigger point for grounding.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="r.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

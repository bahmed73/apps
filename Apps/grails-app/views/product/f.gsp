								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">F point</span>
														<span class="byline">F is a meditation point of manifestation, but action of God, but through a human being, of finding treasures in the galaxy. It correlates to number 7 in numerology, A-M is 1-13, N-Z 14-26 used as trigger points.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="f.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

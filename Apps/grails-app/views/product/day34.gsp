								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">Z Vidya - Day 34</span>
														...
														<span class="byline">Prayer for Brahmananda, Z vidya inspector, to meet kala, kali other half.</span>
														<span class="byline">Prayer for Z vidya, to unveal the mystery of kali, kala, the mummy, male and female.</span>
														<span class="byline">Prayer for Z vidya, to help me find my mother, all the way up, to her first creation, and explode earth (0).</span>
														<span class="byline">Prayer for Z vidya, to help me find my father, all the way up, to his first creation, and explode earth (0).</span>
														<span class="byline">Restart system, grid with shiva, vishnu, brahma, durga, god, the mother and the father.</span>
														<span class="byline">Loop infiniti.</span>
														<span class="byline">Close all chakras, earth (0), kingdom (0), underworld (0), mom (0), pops (0) explode.</span>
														<span class="byline">Loop everyone, (-V#, V#, -H#, H#), explode.</span>
														<span class="byline">Bring it to a point, point strong, earth (0), mom (0), pops (0), kingdom (0), underworld (0), god (0), guru (0), student (0), soul-mate (0), school (0) loop #.</span>

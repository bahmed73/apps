								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">Kalki Vidya - Day 20</span>
														...
														<span class="byline">Remember Allah, Mohammad, Gabriel and Michael at 5 years old.</span>
														<span class="byline">Remember the Mohammad dream: giving water from the two holy streams to people.</span>
														<span class="byline">Remember the Issa dream: the grave among the saints, jesus elevated.</span>
														<span class="byline">Remember the buddha dream: sitting in the cave by the fire with people.</span>
														<span class="byline">Remember the unseen that provided you with the symbol of shiva on your left arm.</span>
														<span class="byline">Remember the unseen that provided you with the cross on your right leg.</span>
														<span class="byline">Remember the unseen that hit you in your sleep, while on drugs and medications, near death.</span>
														<span class="byline">Remember the unseen that gathered when you were 5 years old, praying with your grandfather.</span>
														<span class="byline">Remember the unseen that followed you for eid prayers, with your uncles.</span>
														<span class="byline">Remember the guides, that surrounded you when you were 12 years old, first qualified 100 rakat of prayer.</span>
														<span class="byline">Remember the unseen that guarded you, while your brother, Hassan or Hassam and you were almost killed.</span>
														<span class="byline">Remember the guidance, migration to the holy land of MU, south dakota, america, black hills or axis mundi for education.</span>
														<span class="byline">Remember the guidance to utah, to meet with the saints of the book of mormon, joseph smith and brigham young (university).</span>
														<span class="byline">Remember that you were the first applicant to computer science bacholor degree in all of america, in 1991.</span>
														<span class="byline">Remember that you passed all your exams, no debt, worked at best institutions, made a move to california in 1996.</span>
														<span class="byline">Remember that we guided you to work with the best in california, lockheed martin, novell, ibm, startups, banks and social networks.</span>
														<span class="byline">Remember that we guided you to work with best fathers of christianity, dao, native americans, and hindu religions.</span>
														<span class="byline">Remember your spiritual journey to 25 countries and visiting all the holy places in the world, and their vortexes.</span>
														<span class="byline">Remember your association with mount shasta and all the holy places, only 5 hours away from where you lived.</span>
														<span class="byline">Remember the 12 women, that came into your life at different times, as female guides and their love for you every day.</span>
														<span class="byline">So be thankful and accept them as they are. Send them your love, heart and mind, equally divided, explain time.</span>

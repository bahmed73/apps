							...
							<!-- Banner -->
								<section id="banner">
									<a href="http://foodal.co">
										<span class="image image-full"><asset:image src="school.png"/></span>
										<header>
											<h2>Foodal</h2>
								...
								<section>
									<div>
										...
										<div class="6u">
													...
													<header>
														<span style="font-size:35px;">School!</span>
														<span class="byline">Register your school, enroll as a student, and add teachers.</span>
													</header>
													<div>
													<ul style="list-style-type:disc; margin:50px;font-size:20px;">
													<li>Register your school with us.</li>
													<li>As a teacher, list your skills, find students.</li>
													<li>As a student, find skills to learn and teachers, for affordable prices.</li>
													<li>Lets get started!</li>
													<li>Create a <g:link controller="school" action="create"><span style="color:#8a7e7e;">school.</span></g:link></li>
													<li>Create a <g:link controller="student" action="create"><span style="color:#8a7e7e;">student.</span></g:link></li>
													<li>Create a <g:link controller="teacher" action="create"><span style="color:#8a7e7e;">teacher.</span></g:link></li>
													<li>Create a <g:link controller="event" action="create"><span style="color:#8a7e7e;">event.</span></g:link></li>
													<li>Create a <g:link controller="video" action="create"><span style="color:#8a7e7e;">video.</span></g:link></li>
													<li>Create a <g:link controller="photo" action="create"><span style="color:#8a7e7e;">photo.</span></g:link></li>
													</ul>
													</div>
													<br>

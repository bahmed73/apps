								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">O point</span>
														<span class="byline">O is a meditation point of OM, of finding treasures in the galaxy with God. It is the center of the alphabet, of creation, infiniti, mother, holding black and white.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="o.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

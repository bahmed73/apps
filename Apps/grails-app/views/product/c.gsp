							...
							<!-- Banner -->
								<section id="banner">
									<a href="http://foodal.co">
										<span class="image image-full"><asset:image src="foodal-ween-3.png"/></span>
										<header>
											<h2>Foodal</h2>
								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">C point</span>
														<span class="byline">C is a meditation point of manifestation and creation, number 3 in numerology, of finding treasures in the galaxy. It is the C chord in music, the tone of nada yoga as a trigger point.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="c.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

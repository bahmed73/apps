							...
							<!-- Banner -->
								<section id="banner">
									<a href="http://foodal.co">
										<span class="image image-full"><asset:image src="foodal-profile-5.png"/></span>
										<header>
											<h2>Foodal</h2>
								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">J point</span>
														<span class="byline">J is a meditation point for outward project, ahata nada, of finding treasures in the galaxy by showing I, 9, the inward light, anahata nada, number 1. It is the center of creation, I and J used as a trigger point for action, ishwari and ishwar.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="j.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

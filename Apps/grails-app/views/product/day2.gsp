								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">Shiva Trinity - Day 2</span>
														<span class="byline">Angels (0): Michael (0), Gabriel (0), Raphael (0), Uriel (0), Harut (0), Marut (0), Mary (Durga, 0), 14 Male Granthis, explode.</span>
														<span class="byline">Angels (0): Rehan (0), Agha (0), Mighty (0), Bhutto (0), Zahid (0), Najeeb (0), Benazir (Durga, 0), 14 Female Granthis, explode.</span>
														<span class="byline">Jinn (0): Lemurian (0), Atlantis (0), Arctic (0), Antarctica (0), Stone Henge (0), Agha Jum (0), Qumran (0), explode.</span>
														<span class="byline">Wilderness (0), stone (0), plant (0), animal (0), explode.</span>
														<span class="byline">earth (0), water (0), fire (0), air (0), ether (0), explode.</span>
														<span class="byline">earth (0), water (0), fire (0), wood (0), metal (0), explode.</span>
														<span class="byline">Astrology (0), Numerology (0), Palmistry (0), Footology (0), Tarot Cards (0), Ouija Board (0), Shwet (0), Animal Totem (0), explode.</span>
														<span class="byline">Indra Zen (0), Sumuel shen (0),  Saguna Brahmani Agni (0), Liliath Saguni Brahmani (0), explode.</span>

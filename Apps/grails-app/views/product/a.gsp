								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><g:link controller="product" action="d">B</g:link></li>
												<li><g:link controller="product" action="d">C</g:link></li>
								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">A point</span>
														<span class="byline">A is a meditation point of manifestation and beginning, AUM in yoga, allah, Alif lam meem in Quran, ALM, receving from above, of finding treasures in the galaxy. It is the core of the alphabet, the first vowel, aeiou, zeus alphabets, trigger points.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="a.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

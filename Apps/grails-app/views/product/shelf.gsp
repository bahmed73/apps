...
<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.3.2/jquery.min.js"></script>
	...
	<body class="homepage">
	<a href="http://www.homecook.me"><asset:image src="favicon.png" class="grails-logo"/></a>
		<!-- Header Wrapper -->
								...
								<section>
									<div>
										...
										<div class="6u">
													...
													<header>
														<span style="font-size:20px;">Create a Shelf</span>
														<span >!</span>
													</header>
													<br><br>
													<p style="font-size:16px;">Upload pictures of your products.</p>
													<br><br>
													<p style="font-size:16px;">Add name, price and description.</p>
													<br><br>
													<p style="font-size:16px;">Allow us to generate social media traffic.</p>
													<br><br>
													<p style="font-size:16px;">Measure monthly traffic and buy conversion!</p>
													<br><br>
													<p style="font-size:16px;">Increase customers month over month.</p>
													<br><br>
													<p style="font-size:16px;">Increase revenue by measuring successful products.</p>
													<br><br>
										...
										<div class="6u">
											...
											<div class="6u">
													<section class="box">
													<a href="http://www.mytweetmark.com" class="image image-full"><asset:image src="foodal-homepage-10-400.png"/></a>
													<!--header>
														<h3>Aptent veroeros et aliquam</h3>
														<span class="byline">Posted 45 minutes ago</span>
													</header>
											...
											<div class="6u">
												<section class="box">
													<a href="http://www.homecook.me" class="image image-full"><asset:image src="foodal-homepage-11-400.png"/></a>
													<!--header>
														<h3>Aptent veroeros et aliquam</h3>
														<span class="byline">Posted 45 minutes ago</span>
													</header>

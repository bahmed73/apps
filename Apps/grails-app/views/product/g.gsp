							...
							<!-- Banner -->
								<section id="banner">
									<a href="http://foodal.co">
										<span class="image image-full"><asset:image src="foodal-ween-2.png"/></span>
										<header>
											<h2>Foodal</h2>
								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">G point</span>
														<span class="byline">M is a meditation point of God, of finding treasures in the galaxy. It is the center of the alphabet, the soul, allah, yhwh, OM, a trigger point for prayer.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="g.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

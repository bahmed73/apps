								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">K point</span>
														<span class="byline">K is a meditation point of well-being, of finding treasures in the galaxy, connecting with the ancients, egypts and sumers. It is the invocation of ka, egypt God, hence ra, sun, ka existence, ba is soul, trigger point for movement and compassion.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;width:400px;">
														<g:img dir="images" file="k.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

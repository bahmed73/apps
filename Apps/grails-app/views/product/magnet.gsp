								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">Magnet</span>
														<span class="byline">Magnet is another form of circuit, drawing energy, pulling energy inwards where the voltage between I point, transfered into B and C, E, however the force of B, generated by L, negates, hence C and E transfer back into L. Very little L transfered back into C and E, running into both direction. L is within a container, in a round silo, a round circle, flowing both sides like a snake, a coil or electricity.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="magnet.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

								...
								<section>
									<div>
										...
										<div class="6u">
													...
													<header>
														<span style="font-size:35px;">Foodal Twitter, Signed On!</span>
														<span class="byline">Welcome!</span>
													</header>
													<div>
													...
													<footer class="actions">
														 <g:link controller="product" action="twitterUserData"><asset:image src="continue.png"/></g:link>
														<br><br>
													</footer>
												</section>
											</div>
										<div class="6u">
												<section class="box">
													<a href="http://www.homecook.me" class="image image-full"><asset:image src="twitter-users.png"/></a>
													<!--header>

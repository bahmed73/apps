								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">L point</span>
														<span class="byline">La is the point of manifestation, where god comes to the first chakra, for a male, ALM, alif lam meem, beginning of quran, write, compared to om, which is everything, existence. Om is the center, L is the link.</span>
														<span class="byline">I is the center point of creation, of universe, I AM. It is the big bang that took place from a mother, out of pain and burn. A male is born, the twelve saints.</span>
														<span class="byline">P is a meditation point of calling for help, of finding treasures in the galaxy when hurt. It is the center of the alphabet, A-M, N-Z used as a trigger point for action, get job done.</span>
														<span class="byline">M is a meditation point of manifestation, of finding treasures in the galaxy. It is the center of the alphabet, A-M, N-Z used as a trigger point.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;width:400px;">
														<g:img dir="images" file="l.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">D point</span>
														<span class="byline">D is a meditation point of manifestation, doing, action and work, number 4 in numerology, of finding treasures in the galaxy, building a square. It is core alphabet, A-M, N-Z system of zeus, used as a trigger point for work.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="d.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

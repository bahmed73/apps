								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">Foodal Loop Software!</span>
														...
														<span class="byline">A loop harmonizes IQ - intelligence and EQ - emotional intelligence, with the soul, home and office, temple or kitchen.</span>
								...
								<section>
									<div>
										...
										<div class="6u">
													...
													<div>
													<ul style="list-style-type:disc; margin:50px;font-size:20px;">
													<li>Lay down and relax for 5 minutes.</li>
													<g:actionSubmit value="spin" onclick="return spin();"/>
													</ul>
													</div>

								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">N point</span>
														...
														<span class="byline">M is a meditation point of manifestation, of finding treasures in the galaxy. It is the center of the alphabet, A-M, N-Z used as a trigger point downward.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="n.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

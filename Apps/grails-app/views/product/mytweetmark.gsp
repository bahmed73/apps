								...
								<section>
									<div>
										...
										<div class="6u">
													...
													<header>
														<span style="font-size:35px;">Automate your social media marketing!</span>
														<span class="byline">Take your tweets, make them auto tweets.</span>
													</header>
													<div>
													<ul style="list-style-type:disc; margin:50px;font-size:20px;">
													<li>Need a Twitter account.</li>
													<li>Login with Twitter into auto tweets dashboard.</li>
													<li>Copy upto 100 most popular auto tweets.</li>
													<li>Turn 'auto tweets on' button.</li>
													<li>The auto tweets will always be running, periodically!</li>
													<li>Write blogs to show case your business.</li>
													<li>Auto tweet your business blogs.</li>
													<li>Add contact details, so the new customers can call you directly.</li>
													<li>From Twitter, connect into Facebook profile and fan pages.</li>
													<li>The auto tweets will also display in Facebook.</li>
													<li>No need to spend money on Facebook boost which is expensive.</li>
													<li>We are providing the service for $50.</li>
													</ul>
													</div>
													<br>
													...
													<form controller="product" action="mytweetmark" method="POST">
													<script
										  			src="https://checkout.stripe.com/checkout.js" class="stripe-button"
										  			data-key="pk_live_XG5V3QMNoSvnijnOBH1SRO2I"
										  			data-amount="5000.00"
										  			data-name="mytweetmark"
										...
										<div class="6u">
												<section class="box">
													<a href="http://www.homecook.me" class="image image-full"><asset:image src="mytweetmark.png"/></a>
													<!--header>

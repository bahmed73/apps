								...
								<section>
									<div>
										...
										<div class="6u">
													<section class="box">
													<header>
														<span style="font-size:35px;">E point</span>
														<span class="byline">E is a meditation point of manifestation for earth, ea, as in sumer, Anu, Antu, Enlil, Ninlil and twin, Habul and Isis with the egyption ancestors and creators, of finding treasures in the galaxy. It is used as a trigger point for invocation, God hand, indra or wali, friend.</span>
										...
										<div class="6u">
												<section class="box">
													<div id="spinner" style="display:none;">
														<g:img dir="images" file="e.gif" alt="Loading..."/>
													</div>
												</section>
											</div>
										</div>

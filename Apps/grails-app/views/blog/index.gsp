						...
						<div class="12u">
								...
								<!-- Nav -->
										<nav id="nav">
											<ul>
												...
												<li><button class="button"><g:link controller="blog" action="create"><span style="color:#feff00">Create a Blog</span></g:link></button></li>
							...
							<g:set var="blogs" value="${expandoInstance.blogs}" />	
												...
												<div class="row">
														...
														<br>
														<span style="color:#000000;font-size:12px;">${blogInstance.name}</span>
														</div>
														</g:each>
														</g:if>
														<br><br>
